        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {developerTools.map((tool, index) => (
            <div
              ...
              className="group relative cursor-pointer transform translate-y-4 opacity-0 animate-[slideInUp_0.6s_ease-out_forwards] hover:scale-105 transition-all duration-500"
