        ...
        <div className="bg-gradient-to-br from-gray-900/60 via-gray-800/40 to-gray-900/60 backdrop-blur-sm border border-gray-700/30 rounded-3xl p-8">
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Real-time infrastructure metrics and performance indicators
            </p>
          </div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                        stat.label === 'Active Stations'
                          ? 'bg-blue-500/20 border border-blue-500/30'
                          : stat.label === 'Network Health'
                            ? 'bg-emerald-500/20 border border-emerald-500/30'
                            : stat.label === 'Energy Output'
              ...
              >
                ...
                <div className="flex items-start justify-between mb-6 relative z-10">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3
                        className={`text-xl font-light text-white group-hover:text-${module.variant}-300 transition-colors duration-300 mb-1`}
                      >
                        {module.title}
                      </h3>
                  ...
                  <div className="text-right">
                    <div
                      className={`text-2xl font-light text-white group-hover:text-${module.variant}-300 transition-colors duration-300 mb-1`}
                    >
                      {module.stats}
                    </div>
                    <div className="flex items-center gap-1 justify-end">
                      <div
                        className={`w-2 h-2 bg-${module.variant}-400 rounded-full animate-pulse`}
                      ></div>
                      <div className="text-xs text-gray-400 uppercase tracking-wide">
                        Live
                      </div>
