...
export const FilterButton: React.FC<FilterButtonProps> = ({
  ...
  return (
    ...
    >
      <FunnelIcon
        className={`${iconSizes[size]} group-hover/filter:rotate-12 transition-transform duration-300 relative z-10`}
      />
      ...
      {isActive && (
        <div
          ...
          } rounded-full animate-pulse shadow-sm relative z-10`}
        ></div>
      )}
    </button>
  );
