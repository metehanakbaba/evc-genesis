...
describe('IconContainer', () => {
  ...
  describe('Rendering', () => {
    ...
    it('applies custom iconClassName', () => {
      ...
      render(
        <IconContainer {...defaultProps} iconClassName={customIconClass} />,
      );
  ...
  describe('Variant Props', () => {
    const variants: Array<IconContainerProps['variant']> = [
      'blue',
      'emerald',
      'purple',
      'teal',
  ...
  describe('Size Props', () => {
    const sizes: Array<IconContainerProps['size']> = [
      'xs',
      'sm',
      'md',
      'lg',
  ...
  describe('Disabled State', () => {
    it('renders as disabled when disabled=true', () => {
      const handleClick = jest.fn();
      render(
        <IconContainer {...defaultProps} onClick={handleClick} disabled />,
      );
