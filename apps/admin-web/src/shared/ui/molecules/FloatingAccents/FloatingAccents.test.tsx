...
describe('FloatingAccents', () => {
  describe('Basic Rendering', () => {
    ...
    it('renders correct number of accents based on size', () => {
      ...
      expect(screen.queryByTestId('floating-accents-dot-2')).not.toBeInTheDocument();
    });
    ...
    it('renders custom accent count when specified', () => {
      ...
      expect(screen.queryByTestId('floating-accents-dot-6')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Custom Accents', () => {
    it('renders custom accents when provided', () => {
      const customAccents = [
        { variant: 'emerald' as const, size: 'md' as const, position: { top: '20%', left: '30%' } },
        { variant: 'purple' as const, size: 'sm' as const, position: { bottom: '10%', right: '20%' } },
      ];
  ...
  describe('Container Styling', () => {
    ...
    it('applies custom container dimensions', () => {
      render(<FloatingAccents containerWidth="400px" containerHeight="250px" />);
  ...
  describe('Performance and Edge Cases', () => {
    it('handles zero accent count gracefully', () => {
      ...
      expect(screen.queryByTestId('floating-accents-dot-0')).not.toBeInTheDocument();
    });
    ...
    it('handles single accent', () => {
      ...
      expect(screen.getByTestId('floating-accents-dot-0')).toBeInTheDocument();
      expect(screen.queryByTestId('floating-accents-dot-1')).not.toBeInTheDocument();
    });
  });
