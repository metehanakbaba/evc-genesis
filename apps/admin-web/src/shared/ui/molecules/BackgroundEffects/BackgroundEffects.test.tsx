...
describe('BackgroundEffects', () => {
  describe('Basic Rendering', () => {
    it('renders with default props', () => {
      ...
      expect(
        screen.getByTestId('background-effects-orb-0'),
      ).toBeInTheDocument();
      expect(
        screen.getByTestId('background-effects-orb-4'),
      ).toBeInTheDocument();
    });
    ...
    it('renders correct number of orbs based on size', () => {
      ...
      expect(
        screen.getByTestId('background-effects-orb-2'),
      ).toBeInTheDocument();
      expect(
        screen.queryByTestId('background-effects-orb-3'),
    ...
    it('renders custom orb count when specified', () => {
      ...
      expect(
        screen.getByTestId('background-effects-orb-6'),
      ).toBeInTheDocument();
      expect(
        screen.queryByTestId('background-effects-orb-7'),
      ).not.toBeInTheDocument();
    });
  });
  ...
  describe('Positioning Patterns', () => {
    ...
    it('applies corners pattern correctly', () => {
      ...
      expect(
        screen.getByTestId('background-effects-orb-3'),
      ).toBeInTheDocument();
    });
  ...
  describe('Container Styling', () => {
    ...
    it('applies custom container dimensions', () => {
      render(
        <BackgroundEffects containerWidth="500px" containerHeight="300px" />,
      );
  ...
  describe('Atom Composition', () => {
    it('composes GlowOrb atoms correctly', () => {
      ...
      expect(
        screen.getByTestId('background-effects-orb-1'),
      ).toBeInTheDocument();
      expect(
        screen.getByTestId('background-effects-orb-2'),
      ).toBeInTheDocument();
  ...
  describe('Performance and Edge Cases', () => {
    it('handles zero orb count gracefully', () => {
      ...
      expect(
        screen.queryByTestId('background-effects-orb-0'),
      ).not.toBeInTheDocument();
    });
    ...
    it('handles large orb counts', () => {
      ...
      expect(
        screen.getByTestId('background-effects-orb-19'),
      ).toBeInTheDocument();
    });
  ...
  describe('Custom Props', () => {
    ...
    it('uses custom testId when provided', () => {
      render(
        <BackgroundEffects data-testid="custom-background" orbCount={2} />,
      );
