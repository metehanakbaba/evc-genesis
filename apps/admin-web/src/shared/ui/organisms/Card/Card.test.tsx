...
describe('Card', () => {
  ...
  describe('Variants', () => {
    const variants = [
      ...
      'warning', 'danger', 'glass', 'stat', 'management'
    ] as const;
  ...
  describe('Visual Effects', () => {
    ...
    it('does not render background effects by default', () => {
      ...
      expect(screen.queryByTestId('card-background-effects')).not.toBeInTheDocument();
    });
  ...
  describe('Sub-components', () => {
    describe('Card.Header', () => {
      it('renders with title and description', () => {
        ...
        expect(screen.getByTestId('card-header-title')).toHaveTextContent('Test Title');
        expect(screen.getByTestId('card-header-description')).toHaveTextContent('Test Description');
      });
      ...
      it('renders custom children instead of title/description', () => {
        ...
        expect(screen.queryByTestId('card-header-title')).not.toBeInTheDocument();
      });
  ...
  describe('Error Handling', () => {
    ...
    it('handles invalid variant gracefully', () => {
      ...
      expect(() => render(<Card variant="invalid">Content</Card>)).not.toThrow();
    });
  ...
  describe('Performance', () => {
    ...
    it('handles multiple re-renders efficiently', () => {
      ...
      for (let i = 0; i < 10; i++) {
        rerender(<Card {...defaultProps} variant={i % 2 === 0 ? 'primary' : 'secondary'} />);
      }
