...
describe('StatCard Debug', () => {
  it('should debug GeometricDecoration attributes', () => {
    ...
    console.log(
      'data-variant:',
      geometricDecoration.getAttribute('data-variant'),
    );
    console.log('data-shape:', geometricDecoration.getAttribute('data-shape'));
    console.log(
      'data-pattern:',
      geometricDecoration.getAttribute('data-pattern'),
    );
    console.log(
      'data-thickness:',
      geometricDecoration.getAttribute('data-thickness'),
    );
    console.log('data-size:', geometricDecoration.getAttribute('data-size'));
    console.log(
      'data-position:',
      geometricDecoration.getAttribute('data-position'),
    );
    console.log(
      'data-animated:',
      geometricDecoration.getAttribute('data-animated'),
    );
