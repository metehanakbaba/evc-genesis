 ...
 * 💳 Wallet Screen
 * 
 * Main wallet screen with tab navigation and proper modal overlay
 */

import React from 'react';
import { View, Text, Pressable } from 'react-native';
import { Ionicons } from '@expo/vector-icons';
import { WalletTab } from '../types/wallet.types';
...
export function WalletScreen({ onClose }: WalletScreenProps) {
  ...
  return (
    <View className="flex-1 bg-gray-900">
      {/* Header - Status bar'ın altında düzgün görünmesi için */}
